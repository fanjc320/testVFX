Shader "Custom/Universal Render Pipeline/LitStencilMasked"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Tags{"RenderType" = "Opaque" "RenderPipeline" = "UniversalPipeline" "UniversalMaterialType" = "Lit" "IgnoreProjector" = "True" "ShaderModel"="4.5" "Queue" = "Transparent+2"}
